...
- `GET /api/v1/admin/unanswered-questions` - 미답변 질문 목록 (검색·상태·반복순 정렬)
- `GET /api/v1/admin/unanswered-questions/:id` - 상세 (최근 답변 포함)
- `PATCH /api/v1/admin/unanswered-questions/:id` - 상태 변경 (OPEN/RESOLVED/DISMISSED)
- `POST /api/v1/admin/unanswered-questions/:id/documents/text` - 텍스트 지식 문서 등록
- `POST /api/v1/admin/unanswered-questions/:id/documents` - PDF 지식 문서 등록
