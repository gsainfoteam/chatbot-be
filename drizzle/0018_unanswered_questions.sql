...
CREATE TYPE "public"."unanswered_question_status" AS ENUM('open', 'resolved');--> statement-breakpoint
CREATE TABLE "unanswered_questions" (
	...
	CONSTRAINT "unanswered_questions_occurrence_count_positive" CHECK ("unanswered_questions"."occurrence_count" >= 1)
);
